      ...
      <div className="">
        ...
        <div className="flex justify-center">
          <input
            ...
            className="bg-white text-xl font-medium rounded-md border border-[#8a8a8a] px-3 py-1 h-10 w-1/3"
            ...
            <form onSubmit={addNotes}>
              <div className="flex gap-2 justify-between">
                ...
                <input
                  ...
                  className="bg-white text-xl rounded-md border border-[#d5d3d3] px-3 py-1 w-full"
                ...
                <input
                  ...
                  className="bg-white text-xl rounded-md border border-[#d5d3d3] px-3 py-1 w-full"
                  placeholder="Enter the note tags..."
                  type="text"
                  required
                />
              </div>
              ...
              filteredNotes.map((note) => (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    {/* Edit button */}
                    {/* <button className="bg-black text-lg text-[#f1f1f1] inline-flex items-center justify-center rounded-md cursor-pointer transition-all hover:scale-105 hover:bg-black/80 duration-100 px-2 py-0.5">
                      Edit
                    </button> */}
                    {/* delete  button */}
